...
class Config(object):
  def __init__(self):
    ...
    parser.add_argument('-gm', '--global_margin', type=float, default=0.4)
    parser.add_argument('-lm', '--local_margin', type=float, default=0.4)
    ...
    parser.add_argument('--exp_dir', type=str, default='/home/eric/Disk100G/githubProject/AlignedReID-Re-Production-Pytorch/model/trainSet_conbined/Resnet-50/test')
    ...
    parser.add_argument('--exp_decay_at_epoch', type=int, default=200)
